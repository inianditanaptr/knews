              ...
              <div class="navbar-top">
                <div class="d-flex justify-content-between align-items-center">
                  <ul class="navbar-top-left-menu">
                    <li class="nav-item">
                      <a href="./index-inner.php" class="nav-link">Advertise</a>
                    </li>
                    <li class="nav-item">
                  ...
                  <div>
                    ...
                    >
                      ...
                      >
                        ...
                        <li class="nav-item">
                          <a class="nav-link" href="./nasional.php">Trending</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="./internasional.php">K-Drama</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="./olahraga.php">Kuliner</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="./hiburan.php">Kpop Merch</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="./ekonomi.php">Deestinasi</a>
                        </li>
                        <li class="nav-item">
